...
{
/**
 * @brief QtQuickItem that renders the particle cloud in the scene graph
 */
class ParticleCloudLayerItem : public QQuickItem
{
  Q_OBJECT
...
public:
   ...
   */
  explicit ParticleCloudLayerItem(QQuickItem* parent = nullptr);

  /**
   * @brief Destructor for the ParticleCloudLayerItem class
   */
  ...
  /**
   * @brief Set the particle cloud layer to use for rendering
   *
   * @param particle_render The particle cloud layer to use
   */
  void setRenderer(const std::shared_ptr<ROBOGait::map::layer::ParticleCloudLayer>& particle_render);
...
private:
  ...
  QPointer<ROBOGait::map::rendering::RenderPipeline> pipeline_;               /**< Render pipeline for the particle cloud item */
  std::shared_ptr<ROBOGait::map::rendering::RenderScene> render_scene_;       /**< Render scene for the particle cloud item */
